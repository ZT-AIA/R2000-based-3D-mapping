...
#line 36 "..\\..\\libraries\\rtx-v4.73\\SRC\\rt_System.c"
...
#line 37 "..\\..\\libraries\\rtx-v4.73\\SRC\\rt_System.c"
...
#line 38 "..\\..\\libraries\\rtx-v4.73\\SRC\\rt_System.c"
...
#line 39 "..\\..\\libraries\\rtx-v4.73\\SRC\\rt_System.c"
...
#line 40 "..\\..\\libraries\\rtx-v4.73\\SRC\\rt_System.c"
...
#line 41 "..\\..\\libraries\\rtx-v4.73\\SRC\\rt_System.c"
...
#line 42 "..\\..\\libraries\\rtx-v4.73\\SRC\\rt_System.c"
...
#line 43 "..\\..\\libraries\\rtx-v4.73\\SRC\\rt_System.c"
...
#line 44 "..\\..\\libraries\\rtx-v4.73\\SRC\\rt_System.c"
#line 1 "..\\..\\libraries\\rtx-v4.73\\SRC\\rt_Timer.h"
...
#line 45 "..\\..\\libraries\\rtx-v4.73\\SRC\\rt_System.c"
...
#line 46 "..\\..\\libraries\\rtx-v4.73\\SRC\\rt_System.c"
...
#line 47 "..\\..\\libraries\\rtx-v4.73\\SRC\\rt_System.c"
...
#line 162 "..\\..\\libraries\\rtx-v4.73\\SRC\\rt_System.c"
...
void rt_tsk_lock (void) {
  ...
  if (os_tick_irqn < 0) {
    ...
    os_lock = 1;
    (*((volatile U32 *)0xE000ED04)) = (* &pend_flags = (((*((volatile U32 *)0xE000ED04)) >> 26) & (1<<2 | 1))) << 25;
  } else {
    ((volatile U32 *)0xE000E180)[os_tick_irqn>>5] = 1 << (os_tick_irqn & 0x1F);
    os_lock = 1;
    (*((volatile U32 *)0xE000ED04)) = (* &pend_flags = (((*((volatile U32 *)0xE000ED04)) >> 28) & 1)) << 27;
  }
}
...
void rt_tsk_unlock (void) {
  ...
  if (os_tick_irqn < 0) {
    (*((volatile U32 *)0xE000E010)) = 0x0007;
    os_lock = 0;
    (*((volatile U32 *)0xE000ED04)) = (pend_flags | os_psh_flag<<2) << 26;
    os_psh_flag = 0;
  } else {
    ((volatile U32 *)0xE000E100)[os_tick_irqn>>5] = 1 << (os_tick_irqn & 0x1F);
    os_lock = 0;
    (*((volatile U32 *)0xE000ED04)) = (pend_flags | os_psh_flag) << 28;
    os_psh_flag = 0;
  }
}
