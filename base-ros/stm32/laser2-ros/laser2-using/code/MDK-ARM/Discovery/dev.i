...
#line 5 "..\\inc\\laser\\dev.h"
#line 1 "..\\inc\\laser\\dev_conf.h"



#line 5 "..\\inc\\laser\\dev_conf.h"

 
#line 13 "..\\inc\\laser\\dev_conf.h"
...
static __inline void StepMotor_Stop(StepMotor_CH channel)
{
	if(channel == StepMotor_CH1)
		((TIM_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x0000))->BDTR &= (uint16_t)~((uint16_t)0x8000);
	else if(channel == StepMotor_CH2)
		((TIM_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x0400))->BDTR &= (uint16_t)~((uint16_t)0x8000);
}
static __inline void StepMotor_Run(StepMotor_CH channel)
{
	if(channel == StepMotor_CH1)
		((TIM_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x0000))->BDTR |= ((uint16_t)0x8000);
	else if(channel == StepMotor_CH2)
		((TIM_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x0400))->BDTR |= ((uint16_t)0x8000);
}

extern struct motor_spd motor_spd;
extern void dev_Init(void);
extern void StepMotor_SpeedSet(StepMotor_CH channel, float speed);
extern void Delay_ns(uint32_t dly);
extern void Delay_ms(uint32_t dly);

#line 2 "..\\src\\laser\\dev.c"

 
struct motor_spd motor_spd = {0.1f, 100.0f};
...
static void usart1_Init(void)
{
  ...
  GPIO_PinAFConfig(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0000)),((uint8_t)0x0A),((uint8_t)0x07));
	...
	USART_ClearFlag(((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x1000)), ((uint16_t)0x0020));
...
static void usart3_Init(void)
{
  ...
  GPIO_PinAFConfig(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0C00)),((uint8_t)0x09),((uint8_t)0x07));
	...
	USART_ClearFlag(((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4800)), ((uint16_t)0x0020));
...
static void Timer7Init(void)
{
	...
	TIM_TimeBaseStructure.TIM_Prescaler = 167u;   
...
void Delay_ns(uint32_t dly)
{
	uint32_t timer_cnt;
	dly /= 11.904762f;
	timer_cnt = ((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x1000))->CNT;
	while((((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x1000))->CNT - timer_cnt) < dly);
}
...
static void PWMInit(void)
{
	...
	GPIO_InitStructure.GPIO_Pin = ((uint16_t)0x0001) | ((uint16_t)0x0400) | ((uint16_t)0x0800);
	GPIO_Init(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0C00)), &GPIO_InitStructure);
	GPIO_ResetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0C00)), ((uint16_t)0x0001));   
	GPIO_ResetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0C00)), ((uint16_t)0x0400));  
	GPIO_ResetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0C00)), ((uint16_t)0x0800));
	...
	GPIO_PinAFConfig(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0800)), ((uint8_t)0x08), ((uint8_t)0x03));
	
	 
	TIM_TimeBaseStructure.TIM_Period 	= 20u;
	TIM_TimeBaseStructure.TIM_Prescaler = 0xffffu;
	TIM_TimeBaseStructure.TIM_ClockDivision = ((uint16_t)0x0000);
	TIM_TimeBaseStructure.TIM_CounterMode = ((uint16_t)0x0000);
	TIM_TimeBaseStructure.TIM_RepetitionCounter = 0;
	TIM_TimeBaseInit(((TIM_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x0000)), &TIM_TimeBaseStructure);
	TIM_TimeBaseInit(((TIM_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x0400)), &TIM_TimeBaseStructure);
	...
	TIM_OCInitStructure.TIM_Pulse = 10u;
	...
	TIM_OCInitStructure.TIM_OCNIdleState = ((uint16_t)0x0200);
	TIM_OC1Init(((TIM_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x0000)), &TIM_OCInitStructure);
	TIM_OC3Init(((TIM_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x0400)), &TIM_OCInitStructure);
	TIM_OC1PreloadConfig(((TIM_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x0000)), ((uint16_t)0x0008));
	TIM_OC3PreloadConfig(((TIM_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x0400)), ((uint16_t)0x0008));
	
	TIM_Cmd(((TIM_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x0000)), ENABLE);
	TIM_Cmd(((TIM_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x0400)), ENABLE);
	
	TIM_CtrlPWMOutputs(((TIM_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x0400)), ENABLE);
}
...
static void QEPInit(void)
{
	...
	GPIO_PinAFConfig(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0400)),((uint8_t)0x04),((uint8_t)0x02));
  ...
  GPIO_PinAFConfig(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0C00)),((uint8_t)0x0D),((uint8_t)0x02));
	...
	SYSCFG_EXTILineConfig(((uint8_t)0x01), ((uint8_t)0x03));
	SYSCFG_EXTILineConfig(((uint8_t)0x03), ((uint8_t)0x0E));
	...
	TIM_SelectOutputTrigger(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0400)), ((uint16_t)0x0020));
	TIM_SelectMasterSlaveMode(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0400)), ((uint16_t)0x0080));
	TIM_SelectOutputTrigger(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0800)), ((uint16_t)0x0020));
	TIM_SelectMasterSlaveMode(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0800)), ((uint16_t)0x0080));
	 
	TIM_SelectInputTrigger(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0000)), ((uint16_t)0x0020));
	TIM_SelectSlaveMode(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0000)), ((uint16_t)0x0007));
	TIM_ITRxExternalClockConfig(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0000)), ((uint16_t)0x0020));
	TIM_SelectInputTrigger(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0C00)), ((uint16_t)0x0020));
	TIM_SelectSlaveMode(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0C00)), ((uint16_t)0x0007));
	TIM_ITRxExternalClockConfig(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0C00)), ((uint16_t)0x0020));
	...
	((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0400))->CCMR1 |= (((uint16_t)0x00F0) & (1uL << 4 ));
	((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0400))->CCMR1 |= (((uint16_t)0xF000) & (1uL << 12));
	((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0800))->CCMR1 |= (((uint16_t)0x00F0) & (3uL << 4 ));
	((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0800))->CCMR1 |= (((uint16_t)0xF000) & (3uL << 12));
	...
	EXTI_Init(&EXTI_InitStructure);
	EXTI_ClearFlag(((uint32_t)0x00008));
	EXTI_ClearFlag(((uint32_t)0x04000));
...
void StepMotor_SpeedSet(StepMotor_CH channel, float speed)
{
	if(channel == StepMotor_CH1)
		((TIM_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x0000))->PSC = 168000000uL*60.0f/(speed*21.0f*(128*200uL)*30);
	else
		((TIM_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x0400))->PSC = 168000000uL*60.0f/(speed*21.0f*(128*200uL));
}
...
void SysTickInit(void)
{
	...
	NVIC_SetPriorityGrouping(((uint32_t)0x300) >> 8);
...
void dev_Init(void)
{
	...
	Delay_ms(10);
	PWMInit();
	StepMotor_SpeedSet(StepMotor_CH1,0.1f);
	StepMotor_SpeedSet(StepMotor_CH2,100.0f);
	QEPInit();
	usart1_Init();
	usart3_Init();
