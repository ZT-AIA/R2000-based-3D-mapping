#line 1 "..\\..\\libraries\\lwip-1.4.1\\src\\core\\ipv4\\icmp.c"
...
#line 43 "..\\..\\libraries\\lwip-1.4.1\\src\\core\\ipv4\\icmp.c"
...
#line 47 "..\\..\\libraries\\lwip-1.4.1\\src\\core\\ipv4\\icmp.c"
...
#line 48 "..\\..\\libraries\\lwip-1.4.1\\src\\core\\ipv4\\icmp.c"
...
#line 49 "..\\..\\libraries\\lwip-1.4.1\\src\\core\\ipv4\\icmp.c"
#line 50 "..\\..\\libraries\\lwip-1.4.1\\src\\core\\ipv4\\icmp.c"
...
#line 51 "..\\..\\libraries\\lwip-1.4.1\\src\\core\\ipv4\\icmp.c"
...
#line 52 "..\\..\\libraries\\lwip-1.4.1\\src\\core\\ipv4\\icmp.c"
...
#line 54 "..\\..\\libraries\\lwip-1.4.1\\src\\core\\ipv4\\icmp.c"
...
icmp_input(struct pbuf *p, struct netif *inp)
{
  ...
  if (pbuf_header(p, -hlen) || (p->tot_len < sizeof(u16_t)*2)) {
    do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x00U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { printf ("icmp_input: short ICMP (%" "hu" " bytes) received\n", p->tot_len);; if ((0x00U) & 0x08U) { while(1); } } } while(0);
    goto lenerr;
  }
  ...
  case 8:

    {
      ...
      if (!accepted) {
        do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x00U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { printf ("icmp_input: Not echoing to multicast or broadcast pings\n");; if ((0x00U) & 0x08U) { while(1); } } } while(0);
        ;
        pbuf_free(p);
        return;
      }
    ...
    do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x00U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { printf ("icmp_input: ping\n");; if ((0x00U) & 0x08U) { while(1); } } } while(0);
    if (p->tot_len < sizeof(struct icmp_echo_hdr)) {
      do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x00U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { printf ("icmp_input: bad ICMP echo received\n");; if ((0x00U) & 0x08U) { while(1); } } } while(0);
      goto lenerr;
    }
    if (inet_chksum_pbuf(p) != 0) {
      do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x00U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { printf ("icmp_input: checksum failed for received ICMP echo\n");; if ((0x00U) & 0x08U) { while(1); } } } while(0);
      pbuf_free(p);
      ;
      ;
      return;
    ...
    if (pbuf_header(p, (20 + 14))) {
      ...
      if (r == 0) {
        do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x00U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { printf ("icmp_input: allocating new pbuf failed\n");; if ((0x00U) & 0x08U) { while(1); } } } while(0);
        goto memerr;
      }
    ...
    ((iecho)->type = (0));
#line 201 "..\\..\\libraries\\lwip-1.4.1\\src\\core\\ipv4\\icmp.c"
    iecho->chksum = 0;
    ...
    if(pbuf_header(p, hlen)) {
      ...
      ret = ip_output_if(p, (&current_iphdr_dest), 0,
                   (255), 0, 1, inp);
      if (ret != 0) {
        do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x00U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { printf ("icmp_input: ip_output_if returned an error: %c.\n", ret);; if ((0x00U) & 0x08U) { while(1); } } } while(0);
      }
    }
    break;
  default:
    do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x00U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { printf ("icmp_input: ICMP type %" "d" " code %" "d" " not supported.\n", (s16_t)type, (s16_t)code);; if ((0x00U) & 0x08U) { while(1); } } } while(0);
...
#line 281 "..\\..\\libraries\\lwip-1.4.1\\src\\core\\ipv4\\icmp.c"
...
icmp_send_response(struct pbuf *p, u8_t type, u8_t code)
{
  ...
  q = pbuf_alloc(PBUF_IP, sizeof(struct icmp_echo_hdr) + 20 + 8,
                 PBUF_RAM);
  if (q == 0) {
    do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x00U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { printf ("icmp_time_exceeded: failed to allocate pbuf for ICMP packet.\n");; if ((0x00U) & 0x08U) { while(1); } } } while(0);
    return;
  }
  ...
  iphdr = (struct ip_hdr *)p->payload;
  do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x00U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { printf ("icmp_time_exceeded from ");; if ((0x00U) & 0x08U) { while(1); } } } while(0);
  ...
  do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x00U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { printf (" to ");; if ((0x00U) & 0x08U) { while(1); } } } while(0);
