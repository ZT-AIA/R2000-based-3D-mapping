...
#line 1 "..\\..\\libraries\\ptpd-2.0.0\\src\\dep\\../ptpd.h"
...
#line 29 "..\\..\\libraries\\ptpd-2.0.0\\src\\dep\\../ptpd.h"
...
#line 30 "..\\..\\libraries\\ptpd-2.0.0\\src\\dep\\../ptpd.h"
...
#line 31 "..\\..\\libraries\\ptpd-2.0.0\\src\\dep\\../ptpd.h"
#line 32 "..\\..\\libraries\\ptpd-2.0.0\\src\\dep\\../ptpd.h"
...
#line 33 "..\\..\\libraries\\ptpd-2.0.0\\src\\dep\\../ptpd.h"
...
#line 34 "..\\..\\libraries\\ptpd-2.0.0\\src\\dep\\../ptpd.h"
...
#line 35 "..\\..\\libraries\\ptpd-2.0.0\\src\\dep\\../ptpd.h"
...
#line 36 "..\\..\\libraries\\ptpd-2.0.0\\src\\dep\\../ptpd.h"
#line 1 "..\\inc\\main.h"
...
#line 37 "..\\..\\libraries\\ptpd-2.0.0\\src\\dep\\../ptpd.h"
...
#line 38 "..\\..\\libraries\\ptpd-2.0.0\\src\\dep\\../ptpd.h"
#line 39 "..\\..\\libraries\\ptpd-2.0.0\\src\\dep\\../ptpd.h"
...
#line 40 "..\\..\\libraries\\ptpd-2.0.0\\src\\dep\\../ptpd.h"
...
#line 41 "..\\..\\libraries\\ptpd-2.0.0\\src\\dep\\../ptpd.h"
...
#line 42 "..\\..\\libraries\\ptpd-2.0.0\\src\\dep\\../ptpd.h"
...
#line 43 "..\\..\\libraries\\ptpd-2.0.0\\src\\dep\\../ptpd.h"
...
#line 44 "..\\..\\libraries\\ptpd-2.0.0\\src\\dep\\../ptpd.h"
#line 45 "..\\..\\libraries\\ptpd-2.0.0\\src\\dep\\../ptpd.h"
...
#line 46 "..\\..\\libraries\\ptpd-2.0.0\\src\\dep\\../ptpd.h"
...
#line 47 "..\\..\\libraries\\ptpd-2.0.0\\src\\dep\\../ptpd.h"

#line 1 "..\\..\\libraries\\ptpd-2.0.0\\src\\dep\\../constants.h"
...
#line 52 "..\\..\\libraries\\ptpd-2.0.0\\src\\dep\\../constants.h"
...
#line 78 "..\\..\\libraries\\ptpd-2.0.0\\src\\dep\\../constants.h"
...
#line 49 "..\\..\\libraries\\ptpd-2.0.0\\src\\dep\\../ptpd.h"
#line 1 "..\\..\\libraries\\ptpd-2.0.0\\src\\dep\\../dep/constants_dep.h"
...
#line 50 "..\\..\\libraries\\ptpd-2.0.0\\src\\dep\\../ptpd.h"
#line 1 "..\\..\\libraries\\ptpd-2.0.0\\src\\dep\\../dep/datatypes_dep.h"
...
#line 81 "..\\..\\libraries\\ptpd-2.0.0\\src\\dep\\../dep/datatypes_dep.h"

#line 51 "..\\..\\libraries\\ptpd-2.0.0\\src\\dep\\../ptpd.h"
#line 1 "..\\..\\libraries\\ptpd-2.0.0\\src\\dep\\../datatypes.h"
...
#line 52 "..\\..\\libraries\\ptpd-2.0.0\\src\\dep\\../ptpd.h"
#line 1 "..\\..\\libraries\\ptpd-2.0.0\\src\\dep\\../dep/ptpd_dep.h"
...
#line 15 "..\\..\\libraries\\ptpd-2.0.0\\src\\dep\\../dep/ptpd_dep.h"

#line 23 "..\\..\\libraries\\ptpd-2.0.0\\src\\dep\\../dep/ptpd_dep.h"

#line 30 "..\\..\\libraries\\ptpd-2.0.0\\src\\dep\\../dep/ptpd_dep.h"
 

 
 
#line 40 "..\\..\\libraries\\ptpd-2.0.0\\src\\dep\\../dep/ptpd_dep.h"
 

 
 

#line 52 "..\\..\\libraries\\ptpd-2.0.0\\src\\dep\\../dep/ptpd_dep.h"
...
#line 53 "..\\..\\libraries\\ptpd-2.0.0\\src\\dep\\../ptpd.h"
...
#line 4 "..\\..\\libraries\\ptpd-2.0.0\\src\\dep\\msg.c"
...
void msgUnpackHeader(const octet_t *buf, MsgHeader *header)
{
	...
	header->versionPTP = (*(uint4bit_t*)(buf  + 1)) & 0x0F; 
	header->messageLength = lwip_htons(*(int16_t*)(buf + 2));
	header->domainNumber = (*(uint8_t*)(buf + 4));
	memcpy(header->flagField, (buf + 6), 2);
	memcpy(&msb, (buf + 8), 4);
	memcpy(&lsb, (buf + 12), 4);
	header->correctionfield = lwip_htonl(msb);
	header->correctionfield <<= 32;
	header->correctionfield += lwip_htonl(lsb);
	memcpy(header->sourcePortIdentity.clockIdentity, (buf + 20), 8);
	header->sourcePortIdentity.portNumber = lwip_htons(*(int16_t*)(buf + 28));
	header->sequenceId = lwip_htons(*(int16_t*)(buf + 30));
...
void msgPackHeader(const PtpClock *ptpClock, octet_t *buf)
{
	...
	*(uint8_t*)(buf + 4) = ptpClock->defaultDS.domainNumber;
	...
	memset((buf + 8), 0, 8);
	memcpy((buf + 20), ptpClock->portDS.portIdentity.clockIdentity, 8);
	*(int16_t*)(buf + 28) = lwip_htons(ptpClock->portDS . portIdentity . portNumber);
	*(uint8_t*)(buf + 33) = 0x7F; 
}
...
void msgPackAnnounce(const PtpClock *ptpClock, octet_t *buf)
{
	...
	*(char*)(buf + 0) = *(char*)(buf + 0) | ANNOUNCE; 
	*(int16_t*)(buf + 2)  = lwip_htons(64);
	*(int16_t*)(buf + 30) = lwip_htons(ptpClock->sentAnnounceSequenceId);
	*(uint8_t*)(buf + 32) = CTRL_OTHER;  
	*(int8_t*)(buf + 33) = ptpClock->portDS.logAnnounceInterval;

	 
	memset((buf + 34), 0, 10);  
	*(int16_t*)(buf + 44) = lwip_htons(ptpClock->timePropertiesDS . currentUtcOffset);
	...
	*(int16_t*)(buf + 50) = lwip_htons(ptpClock->defaultDS . clockQuality . offsetScaledLogVariance);
	*(uint8_t*)(buf + 52) = ptpClock->parentDS.grandmasterPriority2;
	memcpy((buf + 53), ptpClock->parentDS.grandmasterIdentity, 8);
	*(int16_t*)(buf + 61) = lwip_htons(ptpClock->currentDS . stepsRemoved);
...
{
	announce->originTimestamp.secondsField.msb = lwip_htons(*(int16_t*)(buf + 34));
	announce->originTimestamp.secondsField.lsb = lwip_htonl(*(uint32_t*)(buf + 36));
	announce->originTimestamp.nanosecondsField = lwip_htonl(*(uint32_t*)(buf + 40));
	announce->currentUtcOffset = lwip_htons(*(int16_t*)(buf + 44));
	...
	announce->grandmasterClockQuality.offsetScaledLogVariance = lwip_htons(*(int16_t*)(buf + 50));
	announce->grandmasterPriority2 = *(uint8_t*)(buf + 52);
	memcpy(announce->grandmasterIdentity, (buf + 53), 8);
	announce->stepsRemoved = lwip_htons(*(int16_t*)(buf + 61));
...
void msgPackSync(const PtpClock *ptpClock, octet_t *buf, const Timestamp *originTimestamp)
{
	...
	*(char*)(buf + 0) = *(char*)(buf + 0) & 0xF0; 
	*(char*)(buf + 0) = *(char*)(buf + 0) | SYNC; 
	*(int16_t*)(buf + 2)  = lwip_htons(44);
	*(int16_t*)(buf + 30) = lwip_htons(ptpClock->sentSyncSequenceId);
	*(uint8_t*)(buf + 32) = CTRL_SYNC; 
	*(int8_t*)(buf + 33) = ptpClock->portDS.logSyncInterval;
	memset((buf + 8), 0, 8);  

	 
	*(int16_t*)(buf + 34) = lwip_htons(originTimestamp->secondsField . msb);
	*(uint32_t*)(buf + 36) = lwip_htonl(originTimestamp->secondsField . lsb);
	*(uint32_t*)(buf + 40) = lwip_htonl(originTimestamp->nanosecondsField);
}

 
void msgUnpackSync(const octet_t *buf, MsgSync *sync)
{
	sync->originTimestamp.secondsField.msb = lwip_htons(*(int16_t*)(buf + 34));
	sync->originTimestamp.secondsField.lsb = lwip_htonl(*(uint32_t*)(buf + 36));
	sync->originTimestamp.nanosecondsField = lwip_htonl(*(uint32_t*)(buf + 40));
}
...
void msgPackDelayReq(const PtpClock *ptpClock, octet_t *buf, const Timestamp *originTimestamp)
{
	...
	*(char*)(buf + 0) = *(char*)(buf + 0) & 0xF0; 
	*(char*)(buf + 0) = *(char*)(buf + 0) | DELAY_REQ; 
	*(int16_t*)(buf + 2)  = lwip_htons(44);
	*(int16_t*)(buf + 30) = lwip_htons(ptpClock->sentDelayReqSequenceId);
	*(uint8_t*)(buf + 32) = CTRL_DELAY_REQ; 
	*(int8_t*)(buf + 33) = 0x7F; 
	memset((buf + 8), 0, 8);
...
{
	delayreq->originTimestamp.secondsField.msb = lwip_htons(*(int16_t*)(buf + 34));
	delayreq->originTimestamp.secondsField.lsb = lwip_htonl(*(uint32_t*)(buf + 36));
	delayreq->originTimestamp.nanosecondsField = lwip_htonl(*(uint32_t*)(buf + 40));
}
...
void msgPackFollowUp(const PtpClock *ptpClock, octet_t*buf, const Timestamp *preciseOriginTimestamp)
{
	...
	*(char*)(buf + 0) = *(char*)(buf + 0) & 0xF0; 
	*(char*)(buf + 0) = *(char*)(buf + 0) | FOLLOW_UP; 
	*(int16_t*)(buf + 2)  = lwip_htons(44);
	*(int16_t*)(buf + 30) = lwip_htons(ptpClock->sentSyncSequenceId - 1);
	*(uint8_t*)(buf + 32) = CTRL_FOLLOW_UP; 
	*(int8_t*)(buf + 33) = ptpClock->portDS.logSyncInterval;

	 
	*(int16_t*)(buf + 34) = lwip_htons(preciseOriginTimestamp->secondsField . msb);
	*(uint32_t*)(buf + 36) = lwip_htonl(preciseOriginTimestamp->secondsField . lsb);
	*(uint32_t*)(buf + 40) = lwip_htonl(preciseOriginTimestamp->nanosecondsField);
}

 
void msgUnpackFollowUp(const octet_t *buf, MsgFollowUp *follow)
{
	follow->preciseOriginTimestamp.secondsField.msb = lwip_htons(*(int16_t*)(buf + 34));
	follow->preciseOriginTimestamp.secondsField.lsb = lwip_htonl(*(uint32_t*)(buf + 36));
	follow->preciseOriginTimestamp.nanosecondsField = lwip_htonl(*(uint32_t*)(buf + 40));
}
...
void msgPackDelayResp(const PtpClock *ptpClock, octet_t *buf, const MsgHeader *header, const Timestamp *receiveTimestamp)
{
	...
	*(char*)(buf + 0) = *(char*)(buf + 0) & 0xF0; 
	*(char*)(buf + 0) = *(char*)(buf + 0) | DELAY_RESP; 
	*(int16_t*)(buf + 2)  = lwip_htons(54);
	   
	memset((buf + 8), 0, 8);

	 
	*(int32_t*)(buf + 8) = lwip_htonl(header->correctionfield >> 32);
	*(int32_t*)(buf + 12) = lwip_htonl((int32_t)header->correctionfield);
	*(int16_t*)(buf + 30) = lwip_htons(header->sequenceId);
	*(uint8_t*)(buf + 32) = CTRL_DELAY_RESP; 
	*(int8_t*)(buf + 33) = ptpClock->portDS.logMinDelayReqInterval; 

	 
	*(int16_t*)(buf + 34) = lwip_htons(receiveTimestamp->secondsField . msb);
	*(uint32_t*)(buf + 36) = lwip_htonl(receiveTimestamp->secondsField . lsb);
	*(uint32_t*)(buf + 40) = lwip_htonl(receiveTimestamp->nanosecondsField);
	memcpy((buf + 44), header->sourcePortIdentity.clockIdentity, 8);
	*(int16_t*)(buf + 52) = lwip_htons(header->sourcePortIdentity . portNumber);
}

 
void msgUnpackDelayResp(const octet_t *buf, MsgDelayResp *resp)
{
	resp->receiveTimestamp.secondsField.msb = lwip_htons(*(int16_t*)(buf + 34));
	resp->receiveTimestamp.secondsField.lsb = lwip_htonl(*(uint32_t*)(buf + 36));
	resp->receiveTimestamp.nanosecondsField = lwip_htonl(*(uint32_t*)(buf + 40));
	memcpy(resp->requestingPortIdentity.clockIdentity, (buf + 44), 8);
	resp->requestingPortIdentity.portNumber = lwip_htons(*(int16_t*)(buf + 52));
}
...
void msgPackPDelayReq(const PtpClock *ptpClock, octet_t *buf, const Timestamp *originTimestamp)
{
	...
	*(char*)(buf + 0) = *(char*)(buf + 0) & 0xF0; 
	*(char*)(buf + 0) = *(char*)(buf + 0) | PDELAY_REQ; 
	*(int16_t*)(buf + 2)  = lwip_htons(54);
	*(int16_t*)(buf + 30) = lwip_htons(ptpClock->sentPDelayReqSequenceId);
	*(uint8_t*)(buf + 32) = CTRL_OTHER; 
	*(int8_t*)(buf + 33) = 0x7F; 
	memset((buf + 8), 0, 8);
...
{
	pdelayreq->originTimestamp.secondsField.msb = lwip_htons(*(int16_t*)(buf + 34));
	pdelayreq->originTimestamp.secondsField.lsb = lwip_htonl(*(uint32_t*)(buf + 36));
	pdelayreq->originTimestamp.nanosecondsField = lwip_htonl(*(uint32_t*)(buf + 40));
}
...
void msgPackPDelayResp(octet_t *buf, const MsgHeader *header, const Timestamp *requestReceiptTimestamp)
{
	...
	*(char*)(buf + 0) = *(char*)(buf + 0) & 0xF0; 
	*(char*)(buf + 0) = *(char*)(buf + 0) | PDELAY_RESP; 
	*(int16_t*)(buf + 2)  = lwip_htons(54);
	...
	*(int16_t*)(buf + 34) = lwip_htons(requestReceiptTimestamp->secondsField . msb);
	*(uint32_t*)(buf + 36) = lwip_htonl(requestReceiptTimestamp->secondsField . lsb);
	*(uint32_t*)(buf + 40) = lwip_htonl(requestReceiptTimestamp->nanosecondsField);
	memcpy((buf + 44), header->sourcePortIdentity.clockIdentity, 8);
	*(int16_t*)(buf + 52) = lwip_htons(header->sourcePortIdentity . portNumber);
...
{
	presp->requestReceiptTimestamp.secondsField.msb = lwip_htons(*(int16_t*)(buf + 34));
	presp->requestReceiptTimestamp.secondsField.lsb = lwip_htonl(*(uint32_t*)(buf + 36));
	presp->requestReceiptTimestamp.nanosecondsField = lwip_htonl(*(uint32_t*)(buf + 40));
	memcpy(presp->requestingPortIdentity.clockIdentity, (buf + 44), 8);
	presp->requestingPortIdentity.portNumber = lwip_htons(*(int16_t*)(buf + 52));
}
...
void msgPackPDelayRespFollowUp(octet_t *buf, const MsgHeader *header, const Timestamp *responseOriginTimestamp)
{
	...
	*(char*)(buf + 0) = *(char*)(buf + 0) & 0xF0; 
	*(char*)(buf + 0) = *(char*)(buf + 0) | PDELAY_RESP_FOLLOW_UP; 
	*(int16_t*)(buf + 2)  = lwip_htons(54);
	*(int16_t*)(buf + 30) = lwip_htons(header->sequenceId);
	*(uint8_t*)(buf + 32) = CTRL_OTHER; 
	*(int8_t*)(buf + 33) = 0x7F; 
	...
	*(int16_t*)(buf + 34) = lwip_htons(responseOriginTimestamp->secondsField . msb);
	*(uint32_t*)(buf + 36) = lwip_htonl(responseOriginTimestamp->secondsField . lsb);
	*(uint32_t*)(buf + 40) = lwip_htonl(responseOriginTimestamp->nanosecondsField);
	memcpy((buf + 44), header->sourcePortIdentity.clockIdentity, 8);
	*(int16_t*)(buf + 52) = lwip_htons(header->sourcePortIdentity . portNumber);
}
...
{
	prespfollow->responseOriginTimestamp.secondsField.msb = lwip_htons(*(int16_t*)(buf + 34));
	prespfollow->responseOriginTimestamp.secondsField.lsb = lwip_htonl(*(uint32_t*)(buf + 36));
	prespfollow->responseOriginTimestamp.nanosecondsField = lwip_htonl(*(uint32_t*)(buf + 40));
	memcpy(prespfollow->requestingPortIdentity.clockIdentity, (buf + 44), 8);
	prespfollow->requestingPortIdentity.portNumber = lwip_htons(*(int16_t*)(buf + 52));
}
