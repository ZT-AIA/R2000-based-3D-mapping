...
#line 16 "..\\inc\\laserCloud.h"
#line 17 "..\\inc\\laserCloud.h"
...
#line 4 "..\\src\\laserCloud.c"

sys_status sys_sta;
extern void rt_tsk_lock(void);
extern void rt_tsk_unlock(void);

sys_mbox_t laserReceiveQue;
...
{
	sys_mbox_trypost(&laserReceiveQue,0);
}

void laser_rec_fetch(void)
{
	sys_arch_mbox_fetch(&laserReceiveQue,0,10);
}
	...
	ip_addr_t *addr,u16_t port)
{
	...
	if(((netpath->tail+1)&(8-1))!=netpath->front)
	{
		if(p->tot_len<=30)
		{
		...
		netpath->tail = (netpath->tail+1)&(8-1);
...
void headProcess(struct pbuf *p,struct net_path *netpath)
{
	...
	if(p->tot_len>60)
	{
		...
		*(int *)pdata = p->time_nsec;
		...
		curcnt=(int16_t)((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0800))->CNT-time4_cnt;
		curPluseCnt+=curcnt;
		time4_cnt = (int16_t)((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0800))->CNT;
...
void laserPointCloudForward_thread(void *msg)
{
	...
	netpath.remoteport =  8010;
	netpath.localport = 8010;
	
	(&netpath . remoteip_addr)->addr = ((u32_t)((101) & 0xff) << 24) | ((u32_t)((1) & 0xff) << 16) | ((u32_t)((168) & 0xff) << 8) | (u32_t)((192) & 0xff);
	(&netpath . localip_addr)->addr = ((u32_t)((10) & 0xff) << 24) | ((u32_t)((1) & 0xff) << 16) | ((u32_t)((168) & 0xff) << 8) | (u32_t)((192) & 0xff);
	...
	udp_bind(netpath.udppcb,((ip_addr_t *)&ip_addr_any),8010);
	for(;;)
	{
		while(netpath.front!=netpath.tail)
		{
			...
			else if(p->tot_len>30&&sys_sta.hostready==1)
			{
			...
			pbuf_free(p);
			sys_mutex_lock(&(netpath.bufmutex));
			netpath.front = (netpath.front+1)&(8-1);
			sys_mutex_unlock(&(netpath.bufmutex));
		}
		laser_rec_fetch();
	}
...
void laserCloud_Init(void)
{
	...
	if(sys_mbox_new(&laserReceiveQue,10)!=0)
	{
		printf("create laserReceiveQue is fail!!!\n");
		return;
	}
	sys_thread_new("laserPointCloudForward_thread",laserPointCloudForward_thread,0,1024*2,osPriorityAboveNormal);
}
