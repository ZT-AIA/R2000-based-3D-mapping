...
#line 48 "..\\src\\stm32f4xx_it.c"
#line 49 "..\\src\\stm32f4xx_it.c"
...
#line 52 "..\\src\\stm32f4xx_it.c"

#line 54 "..\\src\\stm32f4xx_it.c"
...
#line 57 "..\\src\\stm32f4xx_it.c"

 
#line 60 "..\\src\\stm32f4xx_it.c"

 
#line 63 "..\\src\\stm32f4xx_it.c"
...
void ETH_IRQHandler(void)
{
  ...
  if (ETH_GetDMAFlagStatus(((uint32_t)0x00000040)) == SET) 
  {
  ...
  ETH_DMAClearITPendingBit(((uint32_t)0x00000040));
  ETH_DMAClearITPendingBit(((uint32_t)0x00010000));
...
void USART3_IRQHandler(void)
{
	...
	uart_data = ((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4800))->DR & 0x00ffu; 
	
	if(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x1400))->CNT < 500u)
	{
		if(HNMsg_Buf.index >= 128)
			HNMsg_Buf.index = 128 - 1;
		HNMsg_Buf.msg[HNMsg_Buf.rear].hybrid_nav_data[HNMsg_Buf.index++] = uart_data;
	}
	else
	{
		if((HNMsg_Buf.rear + 1)%3 != HNMsg_Buf.front) 
		{
			HNMsg_Buf.index = 0;
			HNMsg_Buf.rear = (HNMsg_Buf.rear + 1)%3;
		...
		HNMsg_Buf.msg[HNMsg_Buf.rear].left_position =  (int16_t)((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0400))->CNT - tim3_cnt;
		HNMsg_Buf.msg[HNMsg_Buf.rear].right_position = (int16_t)((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0800))->CNT - tim4_cnt;
		if(HNMsg_Buf.index >= 128)
			HNMsg_Buf.index = 128 - 1;
		HNMsg_Buf.msg[HNMsg_Buf.rear].hybrid_nav_data[HNMsg_Buf.index++] = uart_data;
		tim3_cnt = ((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0400))->CNT;
		tim4_cnt = ((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0800))->CNT;
	}
...
{
	if(EXTI_GetITStatus(((uint32_t)0x08000))==SET)
	{
		EXTI_ClearFlag(((uint32_t)0x08000));
	...
	else if(EXTI_GetITStatus(((uint32_t)0x04000))==SET)
	{
