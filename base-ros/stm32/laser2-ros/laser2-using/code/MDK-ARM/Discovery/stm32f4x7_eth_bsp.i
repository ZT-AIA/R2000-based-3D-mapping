...
#line 44 "..\\src\\stm32f4x7_eth_bsp.c"
...
#line 45 "..\\src\\stm32f4x7_eth_bsp.c"
#line 1 "..\\inc\\main.h"
...
#line 46 "..\\src\\stm32f4x7_eth_bsp.c"
...
#line 47 "..\\src\\stm32f4x7_eth_bsp.c"
...
void ETH_BSP_Config(void)
{
  ...
  ETH_MACDMA_Config();
	...
	if(ETH_ReadPHYRegister(0x01,((uint16_t)0x10))&1)
	{
		EthInitStatus |= 0x10;
	}
  ...
  if (EthInitStatus == 0) {
    ...
    LCD_DisplayStringLine(((5) * (((sFONT *)LCD_GetFont())->Height)), (uint8_t*)"   Ethernet Init   ");
    LCD_DisplayStringLine(((6) * (((sFONT *)LCD_GetFont())->Height)), (uint8_t*)"      failed      ");
    while(1);
  }
}
...
static void ETH_MACDMA_Config(void)
{
  ...
  RCC_AHB1PeriphClockCmd(((uint32_t)0x02000000) | ((uint32_t)0x04000000) |
                         ((uint32_t)0x08000000) | ((uint32_t)0x10000000), ENABLE);                                             
  ...
  ETH_InitStructure.ETH_ReceiveAll = ((uint32_t)0x00000000);
  ...
  ETH_InitStructure.ETH_MulticastFramesFilter = ((uint32_t)0x00000010);
  ...
  EthInitStatus = ETH_Init(&ETH_InitStructure, 0x01);

   
  ETH_DMAITConfig(((uint32_t)0x00010000) | ((uint32_t)0x00000040), ENABLE);
}
...
void ETH_GPIO_Config(void)
{
  ...
  RCC_AHB1PeriphClockCmd(((uint32_t)0x00000001) | ((uint32_t)0x00000002)
  ...
  GPIO_PinAFConfig(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0400)), ((uint8_t)0x0A), ((uint8_t)0x0B));	
  GPIO_PinAFConfig(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0400)), ((uint8_t)0x0B), ((uint8_t)0x0B));
  GPIO_PinAFConfig(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0400)), ((uint8_t)0x0C), ((uint8_t)0x0B));
  GPIO_PinAFConfig(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0400)), ((uint8_t)0x0D), ((uint8_t)0x0B));
...
uint32_t Eth_Link_PHYITConfig(uint16_t PHYAddress)
{
  ...
  tmpreg = ETH_ReadPHYRegister(PHYAddress, ((uint16_t)0x11));

   
  tmpreg |= (uint16_t)(((uint16_t)0x0002) | ((uint16_t)0x0001));
  if(!(ETH_WritePHYRegister(PHYAddress, ((uint16_t)0x11), tmpreg)))
  {
  ...
  tmpreg = ETH_ReadPHYRegister(PHYAddress, ((uint16_t)0x12));

   
  tmpreg |= (uint16_t)((uint16_t)0x0020);
  if(!(ETH_WritePHYRegister(PHYAddress, ((uint16_t)0x12), tmpreg)))
  {
...
void Eth_Link_ITHandler(uint16_t PHYAddress)
{
  ...
  if(((ETH_ReadPHYRegister(PHYAddress, ((uint16_t)0x12))) & ((uint16_t)0x2000)) != 0)
  {
    if((ETH_ReadPHYRegister(PHYAddress, ((uint16_t)0x10)) & 1))
    {
...
void ETH_link_callback(struct netif *netif)
{
 ...
 uint32_t tmpreg,RegValue;
  ...
  LCD_ClearLine(((5) * (((sFONT *)LCD_GetFont())->Height)));
  LCD_ClearLine(((6) * (((sFONT *)LCD_GetFont())->Height)));
  LCD_ClearLine(((7) * (((sFONT *)LCD_GetFont())->Height)));
  LCD_ClearLine(((8) * (((sFONT *)LCD_GetFont())->Height)));
  LCD_ClearLine(((9) * (((sFONT *)LCD_GetFont())->Height)));

  if((((netif)->flags & 0x10U) ? (u8_t)1 : (u8_t)0))
  {
     
    if(ETH_InitStructure.ETH_AutoNegotiation != ((uint32_t)0x00000000))
    {
       
      timeout = 0;

       
      ETH_WritePHYRegister(0x01, 0, ((uint16_t)0x1000));

       
      do
      {
        timeout++;
      } while (!(ETH_ReadPHYRegister(0x01, 1) & ((uint16_t)0x0020)) && (timeout < (uint32_t)((uint32_t)0x0004FFFF)));  

       
      timeout = 0;

       
      RegValue = ETH_ReadPHYRegister(0x01, ((uint16_t)0x10));
    
       
      if((RegValue & ((uint16_t)0x0004)) != (uint32_t)RESET)
      {
         
        ETH_InitStructure.ETH_Mode = ((uint32_t)0x00000800);  
      }
      else
      {
         
        ETH_InitStructure.ETH_Mode = ((uint32_t)0x00000000);           
      }
       
      if(RegValue & ((uint16_t)0x0002))
      {
             
        ETH_InitStructure.ETH_Speed = ((uint32_t)0x00000000); 
      }
      else
      {
          
        ETH_InitStructure.ETH_Speed = ((uint32_t)0x00004000);      
      }
...
#line 462 "..\\src\\stm32f4x7_eth_bsp.c"
    (&ipaddr)->addr = ((u32_t)((10) & 0xff) << 24) | ((u32_t)((1) & 0xff) << 16) | ((u32_t)((168) & 0xff) << 8) | (u32_t)((192) & 0xff);
...
#line 498 "..\\src\\stm32f4x7_eth_bsp.c"
    EthLinkStatus = 0;
  }
  else
  {
...
#line 521 "..\\src\\stm32f4x7_eth_bsp.c"
  }
}
