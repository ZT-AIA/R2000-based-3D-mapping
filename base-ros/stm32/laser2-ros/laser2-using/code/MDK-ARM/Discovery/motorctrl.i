...
#line 1 "..\\inc\\motorCtrl\\motorctrl.h"
...
#line 403 "..\\..\\libraries\\STM32F4xx_StdPeriph_Driver\\inc\\stm32f4xx_gpio.h"
...
#line 5 "..\\inc\\motorCtrl\\motorctrl.h"
#line 6 "..\\inc\\motorCtrl\\motorctrl.h"
#line 7 "..\\inc\\motorCtrl\\motorctrl.h"
...
#line 8 "..\\inc\\motorCtrl\\motorctrl.h"
...
#line 9 "..\\inc\\motorCtrl\\motorctrl.h"
...
#line 10 "..\\inc\\motorCtrl\\motorctrl.h"
...
#line 2 "..\\src\\motroCtrl\\motorctrl.c"
...
#line 3 "..\\src\\motroCtrl\\motorctrl.c"
#line 4 "..\\src\\motroCtrl\\motorctrl.c"
#line 5 "..\\src\\motroCtrl\\motorctrl.c"
...
#line 6 "..\\src\\motroCtrl\\motorctrl.c"
...
#line 7 "..\\src\\motroCtrl\\motorctrl.c"
...
#line 8 "..\\src\\motroCtrl\\motorctrl.c"
#line 1 "..\\inc\\navigation.h"
...
#line 9 "..\\src\\motroCtrl\\motorctrl.c"
...
{
	sys_mbox_trypost(&motorCtrlQueue,0);
}

static void motor_rec_fetch(void)
{
	sys_arch_mbox_fetch(&motorCtrlQueue,0,10);
}
...
stat_set (*msg_handler[8])(struct net_path *net, void *arg)=
{
...
void motorCtrl_thread(void *msg)
{
	...
	netpath.localport = 20000;
	netpath.remoteport = 20000;
	...
	udp_bind(netpath.udppcb,((ip_addr_t *)&ip_addr_any),20000);
	...
	for(;;)
	{
		while(netpath.front!=netpath.tail)
		{
			...
			netpath.front = (netpath.front+1)%8;
...
void motoCtrl_Init(void)
{
	if(sys_mbox_new(&motorCtrlQueue,10)!=0)
	{
		printf("cteate motorCtrlQueue fail!\n");
	}
	sys_thread_new("motorCtrl_thread",motorCtrl_thread,0,1024*2,osPriorityNormal);
}
