...
#line 46 "..\\..\\libraries\\STM32F4-Discovery\\stm32f4_discovery.c"
...
const uint16_t GPIO_PIN[4] = {((uint16_t)0x0001), ((uint16_t)0x2000), ((uint16_t)0x4000),
                                 ((uint16_t)0x8000)};
...
USART_TypeDef* COM_USART[2] = {((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x1400)),((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4800))}; 

GPIO_TypeDef* COM_TX_PORT[2] = {((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0800)), ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0800))};
 
GPIO_TypeDef* COM_RX_PORT[2] = {((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0800)), ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0800))};

const uint32_t COM_USART_CLK[2] = {((uint32_t)0x00000020), ((uint32_t)0x00040000)};
...
const uint16_t COM_TX_PIN[2] = {((uint16_t)0x0040), ((uint16_t)0x0400)};

const uint16_t COM_RX_PIN[2] = {((uint16_t)0x0080), ((uint16_t)0x0800)};
 
const uint16_t COM_TX_PIN_SOURCE[2] = {((uint8_t)0x06), ((uint8_t)0x0A)};

const uint16_t COM_RX_PIN_SOURCE[2] = {((uint8_t)0x07), ((uint8_t)0x0B)};
 
const uint16_t COM_TX_AF[2] = {((uint8_t)0x08), ((uint8_t)0x07)};
 
const uint16_t COM_RX_AF[2] = {((uint8_t)0x08), ((uint8_t)0x07)};
